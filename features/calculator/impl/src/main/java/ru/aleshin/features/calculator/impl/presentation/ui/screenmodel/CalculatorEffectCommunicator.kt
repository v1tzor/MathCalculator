 ...
 */
internal interface CalculatorEffectCommunicator : EffectCommunicator<CalculatorEffect> {

    class Base @Inject constructor() : CalculatorEffectCommunicator,
        EffectCommunicator.Abstract<CalculatorEffect>()
}