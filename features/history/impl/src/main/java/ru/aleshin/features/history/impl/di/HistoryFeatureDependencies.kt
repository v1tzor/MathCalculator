...
*/
package ru.aleshin.features.history.impl.di
 ...
 */
interface HistoryFeatureDependencies : BaseFeatureDependencies {
    val coroutineManager: CoroutineManager
    val globalRouter: Router
    val calculatorFeatureStarter: CalculatorFeatureStarter
