...
import ru.aleshin.features.history.impl.domain.common.HistoryErrorHandler
...
internal interface DomainModule {
    ...
    @Binds
    fun bindHistoryEitherWrapper(wrapper: HistoryEitherWrapper.Base): HistoryEitherWrapper

    @Binds
    fun bindHistoryErrorHandler(handler: HistoryErrorHandler.Base): HistoryErrorHandler
}