 ...
 */
internal interface HistoryEitherWrapper : EitherWrapper<HistoryFailures> {

    class Base @Inject constructor(errorHandler: HistoryErrorHandler) : HistoryEitherWrapper,
        EitherWrapper.Abstract<HistoryFailures>(errorHandler)
}