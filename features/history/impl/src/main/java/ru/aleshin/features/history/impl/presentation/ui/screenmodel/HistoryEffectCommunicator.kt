 ...
 */
internal interface HistoryEffectCommunicator : EffectCommunicator<HistoryEffect> {

    class Base @Inject constructor() : HistoryEffectCommunicator,
        EffectCommunicator.Abstract<HistoryEffect>()
}