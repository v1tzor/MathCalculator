 ...
 */
internal interface HistoryStateCommunicator : StateCommunicator<HistoryViewState> {

    class Base @Inject constructor() : HistoryStateCommunicator,
        StateCommunicator.Abstract<HistoryViewState>(defualtState = HistoryViewState())
}